...
relevant_skills = [
    ...
    'backend', 'full stack', 'software development', 'UX', 'user experience', 
    'UI', 'user interface', 'automation', 'testing', 'IoT', 'blockchain', 'VR/AR',
...
for job_link in job_links:
    response = requests.get(job_link, verify=False)
    ...
    if response.status_code == 200:
        ...
        print(f"Failed to retrieve job offer: {job_link}")
